...
?>
        ...
        <p>
            <label for="subclub_delete_premium_option"><?php _e('On delete', 'subclub'); ?></label>
            <select name="subclub_delete_premium_option" id="subclub_delete_premium_option">
                <option value="delete" <?php selected($delete_option_value, 'delete'); ?>><?php _e('Delete premium', 'subclub'); ?></option>
                <option value="keep" <?php selected($delete_option_value, 'keep'); ?>><?php _e('Keep premium', 'subclub'); ?></option>
            </select>
        </p>
        <?php
    }
    ...
    static function subclub_save_meta_box_data($post_id)
    {
        ...
        $delete_option = sanitize_text_field($_POST['subclub_delete_premium_option']);
